...
export default async function LoginPage({
  ...
  return (
    <main className="min-h-screen grid lg:grid-cols-[1.1fr_1fr]">
      ...
      >
        {/* Faixa CMYK vertical à esquerda */}
        ...
        <div className="flex flex-col justify-between p-12 pl-16 w-full max-w-2xl mx-auto">
          <div className="space-y-12">
            <PrintLabMark variant="wordmark-dark" size="lg" />
          ...
          <div className="space-y-5">
            ...
            <div className="grid grid-cols-4 gap-1 text-[10px] uppercase tracking-[0.2em] font-mono text-white/50">
              <div className="text-magenta">M&nbsp;100</div>
              <div className="text-yellow">Y&nbsp;100</div>
              <div className="text-cyan">C&nbsp;100</div>
              <div>K&nbsp;100</div>
            </div>
      ...
      <section className="flex items-center justify-center p-6 sm:p-12 bg-background">
        <div className="w-full max-w-sm space-y-8">
          <div className="lg:hidden">
            <PrintLabMark variant="wordmark" size="md" />
          </div>
